...
func (x *TaskModel) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
func (x *TaskModel) GetStartTime() string {
	if x != nil {
		return x.StartTime
	}
	return ""
...
func (x *TaskModel) GetEndTime() string {
	if x != nil {
		return x.EndTime
	}
	return ""
...
var file_taskModel_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x6c, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x61, 0x73, 0x6b, 0x49, 0x44, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x06, 0x74, 0x61, 0x73, 0x6b, 0x49, 0x44, 0x12, 0x16, 0x0a, 0x06, 0x75,
	...
	0x69, 0x6d, 0x65, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x73, 0x65, 0x72,
